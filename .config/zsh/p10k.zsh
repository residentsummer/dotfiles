# Generated by Powerlevel10k configuration wizard on 2020-07-17 at 17:48 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|kc|kca|kce|kcy|kcl|kla|klh|kln|klp|kns|krd|by-host|by-age|by-ns'

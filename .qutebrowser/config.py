...
## Type: String
c.content.headers.accept_language = 'en-US,en;q=0.9,ru;q=0.8'
...
## Type: String
c.content.headers.user_agent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.186 Safari/537.36"
...
## Type: FormatString
c.window.title_format = '{private}{title_sep}{perc}{title}{title_sep}qutebrowser'
